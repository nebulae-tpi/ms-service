...
![Intro](docs/images/ms-service_intro.png "Intro")
# Table of Contents
  ...
  * [BackEnd](#backend)
    *  [service](#backend_service)
        * [Environment variables](#backend_service_env_vars)
        * [Event Sourcing](#backend_service_eventsourcing)
        * [CronJobs](#backend_service_cronjobs)
...
│   ├── service                     => Micro-BackEnd responsible for ...
...
Note: You may find the GraphQL schema [here](api/emi-gateway/graphql/service/schema.gql)
...
## service <a name="backend_service"></a>
...


### Environment variables <a name="backend_service_env_vars"></a>
...
```
#### Notes: 
  * ENV VARS for development are [here](backend/service/.env)
  * ENV VARS for production are [here](deployment/gke/deployment-service.yaml)

### Event Sourcing <a name="backend_service_eventsourcing"></a>
...
### CronJobs <a name="backend_service_cronjobs"></a>
...
### 1. clone this repo  
   ```git clone https://github.com/nebulae-tpi/ms-service.git```  
...
### 5. Compose FrontEnd
```
nebulae compose-ui development --shell-type=FUSE2_ANGULAR --shell-repo=https://github.com/nebulae-tpi/emi --frontend-id=emi --output-dir=/FULL_PATH_TO_REPO/ms-service/playground/emi  --setup-file=/FULL_PATH_TO_REPO/ms-service/etc/mfe-setup.json
```

### 6. Compose the API emi-gateway
```
nebulae compose-api development --api-type=NEBULAE_GATEWAY --api-repo=https://github.com/nebulae-tpi/emi-gateway --api-id=emi-gateway --output-dir=FULL_PATH_TO_REPO/ms-service/playground/emi-gateway  --setup-file=FULL_PATH_TO_REPO/ms-service/etc/mapi-setup.json
```
...
* set this key value to the **JWT_PUBLIC_KEY** atribute in the following files: *WORKING_FOLDER*/ms-service/backend/service/.env   *WORKING_FOLDER*/ms-service/playground/emi-gateway/.env  
